    ...
    <main className="container">
      <section className="bg-[#F9FFF6] rounded-3xl overflow-hidden pt-16 relative">
        <div className="md:grid grid-cols-2 lg:px-24 px-16 z-50">
          ...
          <div className="place-self-end justify-center flex">
            <div className="relative bg-gradient-to-b from-foundry-primary via-foundry-primary to-[#306348] rounded-3xl text-primary-white w-[270px] pb-5">
              <img
        ...
        <div className="bg-foundry-secondary md:grid grid-cols-3 gap-x-20 py-8 px-8 space-y-8 md:space-y-0 md:px-16 mt-5 z-50">
      ...
      <section className="md:grid grid-cols-[1fr,0.7fr] gap-x-20 py-16">
        <div>
          <h2 className="font-medium text-3xl md:text-4xl">
            Effortlessly expand your sales reach, rapidly and seamlessly, across
            any location
          </h2>
        ...
        <div className=" h-full place-self-end justify-center flex">
          <div className="rounded-3xl text-primary-white w-[370px] bg-foundry-secondary relative overflow-hidden">
            <img src="/images/aaaa.png" alt="" className="object-contain" />
            <div className="rounded-l-2xl bg-[#EFEFEF]/10 backdrop-blur border-t-2 border-b-2 border-l-2 border-white/60 w-[80%] h-[65%] absolute top-16 right-0 p-4 overflow-hidden">
              <div className="rounded-md p-2 w-full h-full bg-[#EFEFEF]/20">
                <div className="flex items-center gap-x-2 border-b border-b-black/20 pb-1.5">
                  <h5 className="bg-[#F9FFF6]/60 rounded-md p-2 text-foundry-secondary">
                    WC
                  </h5>
      ...
      <section className="py-16">
        ...
        <div className="lg:grid grid-cols-[0.4fr,1fr] gap-x-10 xl:gap-x-20">
          <div className="flex flex-col md:grid grid-cols-2 lg:flex lg:flex-col space-y-6 justify-center md:justify-start">
            ...
            <div className="bg-foundry-secondary rounded-xl p-4 lg:px-5 flex justify-between items-center gap-x-4 xl:gap-x-12 text-primary-white">
              <p>
                Streamline the allocation of resources and time slots,
                optimising bookings to minimise gaps and maximise utilisation
              </p>
              <div className="text-foundry-primary bg-primary-white p-2 rounded-full">
