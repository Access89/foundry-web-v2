...
const FinancialServiceExpansion = () => {
  ...
  return (
    <main className="container">
      <section className="flex items-center  flex-col justify-between gap-10 py-20 border-3 border-white rounded-xl   ">
        ...
        <div className='px-6'>
          ...
          <p className="text-foundry-primary lg:text-[1.2rem] text-center  my-5">
            {current?.description}
          </p>
        </div>
        {current?.['video-link'] && (
      ...
      <section className="py-10 pt-28 lg:pt-20">
        <div className="text-center">
          ...
          <p className="text-foundry-primary lg:text-[1.2rem]  my-5">
...
const InfoCard = ({
  ...
  return (
    <div className="bg-secondary-light rounded-2xl p-4 lg:px-6 lg:py-6 w-full flex flex-col justify-between gap-6 hover:scale-[1.02] duration-700 hover:shadow-lg cursor-pointer">
      <div className="flex flex-col gap-y-3 bg-foundry-secondary/90 w-fit p-2 rounded-md">
