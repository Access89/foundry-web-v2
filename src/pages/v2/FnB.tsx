      ...
      <header className="relative pt-32 md:pt-28 xl:pt-44 pb-16 md:pb-24 xl:pb-32 px-4 md:px-8 overflow-hidden bg-white">
        <div className="max-w-10xl px-4 md:px-6 lg:px-8 mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <div className="bg-zinc-900 text-white p-10 flex flex-col justify-between h-96 overflow-hidden relative rounded-xl">
              ...
              <div className="flex gap-4 mt-8">
                <div className="flex-1 bg-zinc-800 p-4 border-l-4 border-white rounded-r-lg">
                ...
                <div className="flex-1 bg-zinc-800 p-4 border-l-4 border-zinc-500 rounded-r-lg">
                  <div className="text-xs opacity-50 mb-1">
                    Table 2 • 5m ago
                  </div>
            ...
            <div className="bg-zinc-50 p-10 border border-zinc-200 flex flex-col justify-between h-96 relative overflow-hidden rounded-xl">
              <div className="relative z-10">
