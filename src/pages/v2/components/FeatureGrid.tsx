      ...
      <div className="max-w-7xl mx-auto">
        ...
        {activeSegment === "merchant" ? (
          ...
          <div className="grid md:grid-cols-3 md:grid-rows-3 gap-6 h-auto">
            ...
            <div className="md:col-span-2 md:row-span-1 p-10 relative overflow-hidden group bg-gradient-to-br from-indigo-900 via-blue-900 to-slate-900 border border-indigo-500/30">
              <div className="relative z-10">
                <div className="w-12 h-12 bg-indigo-600 text-white flex items-center justify-center mb-6">
            ...
            {/* 2. TAILORED SEGMENTS */}
            <div className="md:row-span-2 p-8 bg-slate-900 border border-slate-800 relative overflow-hidden flex flex-col">
              <div className="mb-6">
                <div className="w-12 h-12 bg-slate-800 flex items-center justify-center mb-6 text-indigo-400">
              ...
              <div className="flex-1 space-y-3">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-slate-800/50 border border-slate-700/50 hover:bg-slate-800 transition-colors cursor-pointer group"
                  >
            ...
            <div className="p-8 bg-slate-900 border border-slate-800 relative overflow-hidden group">
              <div className="relative z-10">
                <div className="w-10 h-10 bg-slate-800 flex items-center justify-center mb-4 text-green-400">
            ...
            <div className="p-8 bg-slate-900 border border-slate-800 relative overflow-hidden group">
              <div className="relative z-10">
                <div className="w-10 h-10 bg-slate-800 flex items-center justify-center mb-4 text-indigo-400">
            ...
            {/* 5. DATA & AI FABRIC */}
            <div className="md:col-span-3 p-8 bg-slate-950 border border-slate-900 relative overflow-hidden flex flex-col md:flex-row items-center gap-8 group">
              <div className="flex-1 relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-slate-800 flex items-center justify-center text-purple-400">
